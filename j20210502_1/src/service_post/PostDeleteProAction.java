...
public class PostDeleteProAction implements CommandProcess {
   ...
   public String requestPro(HttpServletRequest request, HttpServletResponse response)
      ...
      try {
         ...
         System.out.println("Delete Post board_num->" + board_num);
         System.out.println("Delete Post Result->" + result);
         System.out.println("Delete Post post_num->" + post_num);
         System.out.println("Delete Post pageNum->" + pageNum);
      } 
      catch (Exception e) {
