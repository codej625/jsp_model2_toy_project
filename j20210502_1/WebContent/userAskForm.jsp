		...
		<div class="container">
				<div class="view-account">
										...
										<div class="side-bar">
												...
												<nav class="side-menu">
														<ul class="nav">
																...
																<li class="active"><a href="userAskForm.do?user_id=${sessionID}&user_code=${sessionCODE}&board_num=3"><span class="fa fa-envelope"></span>나의 문의내역</a></li>
						...
						<div class="content-panel">
								<form class="form-horizontal">
										<fieldset class="fieldset">
												<input type="text" name="user_id" value="${user_id }" readonly="readonly"><h3 class="fieldset-title">님의 문의내역</h3>
												<table border="0">
														<tr>
																<td>게시번호</td>
																<td>제목</td>
														...
														<c:if test="${totCnt > 0 }">
																<c:forEach var="post" items="${list }" varStatus="status">
																		<tr>
																				<td>${startNum }</td>
																				<td class="left" width=200><a href='postContent.do?board_num=${board_num}&post_num=${post.post_num}&pageNum=${currentPage}&user_id=${user_id }'> ${post.post_name }</a></td>
                        ...
                        <div class="col-md-10 col-sm-9 col-xs-12 col-md-push-2 col-sm-push-3 col-xs-push-0">
                            <input class="btn btn-primary" type="button" value="글쓰기" onclick="location.href='postWriteForm.do?user_id=${user_id }&board_num=${board_num }'">
                        </div>
                    </div>
						</div>
				</div>
