...
<body>
                    ...
                    <div class="side-bar">
                        ...
                        <nav class="side-menu">
                            <ul class="nav">
                                ...
                                <li class="active"><a href="boardFreeList.do?board_num=1"><span class="fa"></span>자유게시판</a></li>
                    ...
                    <div class="content-panel">
                        <form class="form-horizontal">
                            <fieldset class="fieldset">
                                <h3 class="fieldset-title">자유게시판</h3>
                            ...
                            <div class="form-group">
                                <div class="col-md-10 col-sm-9 col-xs-12 col-md-push-2 col-sm-push-3 col-xs-push-0">
                                    <a href="postWriteForm.do?board_num=${board_num}&post_num=${post_num}&pageNum=${currentPage }">자유 글쓰기</a> <input type="text" id="board_num" value="${board_num}"> <input type="text" id="pageNum" value="${currentPage }"> <input type="text" id="post_num" value="${post_num}">
                                </div>
                            </div>
    ...
    <%-- <div class="content">
        <div class="container">
            ...
            <table>
                <tr>
                    <td><a class="nav2" id="nav2" href="boardNoticeList.do?board_num=0">공지게시판</a></td>
                </tr>
                <tr>
                    <td><a class="nav2" id="nav2" href="boardFreeList.do?board_num=1">자유게시판</a></td>
                </tr>
                <tr>
                    <td><a class="nav2" id="nav2" href="boardMarketList.do?board_num=2">마켓게시판</a></td>
                </tr>
            </table>
            <table>
                <tr>
