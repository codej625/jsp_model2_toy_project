										...
										<div class="content-panel">
												<form class="form-horizontal">
														<fieldset class="fieldset">
																<h3 class="fieldset-title">마켓게시판</h3>
                                        ...
                                        <input type="url" class="form-control" value="#사용자 주소">
														...
														<div class="form-group">
																<div class="col-md-10 col-sm-9 col-xs-12 col-md-push-2 col-sm-push-3 col-xs-push-0">
																		<a href="postWriteForm.do?board_num=${board_num}&post_num=${post_num}&pageNum=${currentPage }">마켓 글쓰기</a> <input type="text" id="board_num" value="${board_num}"> <input type="text" id="pageNum" value="${currentPage }"> <input type="text" id="post_num" value="${post_num}">
																</div>
														</div>
