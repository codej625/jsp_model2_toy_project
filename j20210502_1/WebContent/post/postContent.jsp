										...
										<div class="content-panel">
														...
														<fieldset class="fieldset">
																...
																<div class="form-group">
																		<div class="col-md-10 col-sm-9 col-xs-12 col-md-push-2 col-sm-push-3 col-xs-push-0">
																				<input class="btn btn-primary" type="button" value="수정" onclick="location.href='postUpdateForm.do?board_num=${post.board_num}&post_num=${post.post_num}&pageNum=${pageNum}'"> <input class="btn btn-primary" type="button" value="답변작성" onclick="location.href='postWriteForm.do?post_num=${post.post_num}&pageNum=${pageNum}'"> <input class="btn btn-primary" type="button" value="삭제" onclick="location.href='postDeleteForm.do?board_num=${board_num}&post_num=${post_num}'"> <input class="btn btn-primary" type="button" value="목록" onclick="location.href='boardList.do?pageNum=${pageNum}'">
																		</div>
																</div>
																<input type="text" id="board_num" value="${board_num}"> <input type="text" id="post_num" value="${post_num}">
														</fieldset>
														<hr>
												</form>
												<form name="frm">
												<fieldset class="fieldset">
														<table border="0">
																<!--댓글입력  -->
																<tr>
																		<td colspan="4"><textarea name="comment_cont" rows="5" cols="100" placeholder="댓글을 입력하세요"></textarea>
																		 ...
																		 <br> <br> 
																		 <input class="btn btn-primary" type="button" onclick="commentChk()" value="확인"></td>
														...
														<table border="0">
																<c:if test="${totCnt > 0}">
																		<c:forEach var="comment" items="${comment_list }" varStatus="status">
																				<tr>
																						<td colspan="3"><c:if test="${comment.post_lv > 0 }">
																								...
																								<br><br>
																								<a href="postDeleteForm.do?board_num=${board_num}&post_num=${comment.post_num}&pageNum=${pageNum}">
                                            <input style="width: 55px; height: 25px; font-size: 8px; padding: 0 2px 2px 0;" class="btn btn-primary" type="button" value="댓글 삭제"></a> 
                                            
                                            <a href="postUpdateForm.do?board_num=${board_num}&post_num=${comment.post_num}&pageNum=${pageNum}"> 
                                            <input style="width: 65px; height: 25px; font-size: 8px; padding: 0 2px 2px 0;" class="btn btn-primary" type="button" value="댓글 수정"></a> 
                                            
                                            <c:if test="${comment.post_lv >= 0 }">
                                            <input style="width: 35px; height: 25px; font-size: 8px; padding: 0 2px 2px 0;" class="btn btn-primary" type="button" value="답글" name="find_${status.count }" onclick="showRecommentBtn('${status.count }')">
                                                </c:if>
                                                <hr>
																							</td>	 
																						</tr>
																				    ...
																				    <tr class="hide${status.count}" style="display: none">
																						<td colspan="3">
																						<textarea name="reCommentCont" rows="5" cols="100" placeholder="답글을 입력하세요">
																						</textarea> 
																						<input type="hidden" name="board_num" value="${post.board_num}"> 
																						<input type="hidden" name="post_num" value="${post.post_num}"> 
																						...
																						<input type="hidden" name="pageNum" value="${pageNum}"> 
																						<input type="button" value="답글 등록" onclick="reCommentChk()"></td>
																				</tr>
																		</c:forEach>
																</c:if>
														</table>
