...
<div class="wrap">
		<div class="login" style="color: #495057;">
				...
				<div class="submit">
						<input onkeyup="enterkey();" type="button" value="로그인" id="testBtn" name="testBtn">
				</div>
		</div>
</div>
<form id="form" action="userLoginPro.do" method="post" name="frm">
		<input type="hidden" id="id" name="user_id" value=""> <input type="hidden" id="pw" name="user_pw" value="">
</form>
<!-- <form id="form" action="userLoginPro.do" method="post" name="frm">
	<table border="1">
		<tr>
...
<script type="text/javascript">
  ...
  function deleteCookie(user_id) {
    ...
    document.cookie = user_id + "= " + "; expires=" + expireDate.toUTCString();
  }
